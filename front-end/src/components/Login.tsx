          ...
          <div className="p-8">
            ...
            {!isRegister ? (
              ...
              <form className="space-y-4" onSubmit={doRegister}>
                <div>
                  <label htmlFor="register-display-name" className="block text-sm font-medium text-gray-700 mb-2">Display Name *</label>
                  <div className="relative">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="register-weight" className="block text-sm font-medium text-gray-700 mb-2">Weight (kg)</label>
                    <div className="relative">
                  ...
                  <div>
                    <label htmlFor="register-height" className="block text-sm font-medium text-gray-700 mb-2">Height (cm)</label>
                    <div className="relative">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="register-age" className="block text-sm font-medium text-gray-700 mb-2">Age</label>
                    <div className="relative">
                  ...
                  <div>
                    <label htmlFor="register-sex" className="block text-sm font-medium text-gray-700 mb-2">Sex</label>
                    <div className="relative">
